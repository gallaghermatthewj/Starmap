...
Shader "Space Graphics Toolkit/Terrain Planet"
{
   Properties
   {
	...
	[Header(BAKED DETAIL)]
	[Toggle(_BAKEDDETAIL_ON_DEF_1)] _HasBakedDetail_Ext_1 ("	Enabled", Float) = 0
	_BakedDetailFadeRange_Ext_1("	Fade Range", Float) = 1000.0
	_BakedDetailScaleR_Ext_1("	Strength R", Range(0,5)) = 1
	_BakedDetailScaleG_Ext_1("	Strength G", Range(0,5)) = 1
	_BakedDetailScaleB_Ext_1("	Strength B", Range(0,5)) = 1
	_BakedDetailScaleA_Ext_1("	Strength A", Range(0,5)) = 1


	[Header(BAKED DETAIL)]
	[Toggle(_BAKEDDETAIL_ON_DEF_2)] _HasBakedDetail_Ext_2 ("	Enabled", Float) = 0
	_BakedDetailFadeRange_Ext_2("	Fade Range", Float) = 1000.0
	_BakedDetailScaleR_Ext_2("	Strength R", Range(0,5)) = 1
	_BakedDetailScaleG_Ext_2("	Strength G", Range(0,5)) = 1
	_BakedDetailScaleB_Ext_2("	Strength B", Range(0,5)) = 1
	_BakedDetailScaleA_Ext_2("	Strength A", Range(0,5)) = 1
   ...
   SubShader
   {
	...
	#pragma shader_feature_local _ _DETAIL_ALBEDO
	#pragma shader_feature_local _ _DETAIL_NORMAL


	#pragma shader_feature_local _ _BAKEDDETAIL_ON


	#pragma shader_feature_local _ _BAKEDDETAIL_ON_DEF_1


	#pragma shader_feature_local _ _BAKEDDETAIL_ON_DEF_2
...
// HDRP Adapter stuff
	...
	float _BakedDetailFadeRange_Ext_1;
	float _BakedDetailScaleR_Ext_1;
	float _BakedDetailScaleG_Ext_1;
	float _BakedDetailScaleB_Ext_1;
	float _BakedDetailScaleA_Ext_1;


	float _BakedDetailFadeRange_Ext_2;
	float _BakedDetailScaleR_Ext_2;
	float _BakedDetailScaleG_Ext_2;
	float _BakedDetailScaleB_Ext_2;
	float _BakedDetailScaleA_Ext_2;
...
#define unity_WorldToObject GetWorldToObjectMatrix()
	...
	void Ext_SurfaceFunction6 (inout Surface o, inout ShaderData d)
	{
			...
			float polar = d.extraV2F0.x;
			float noise = (sample_noise(coords, polar) - 0.5f) * 5.0f;
			float fade  = saturate(d.blackboard.worldDistance / _BakedDetailFadeRange_Ext_1);
			...
			#if _DETAIL_ALBEDO
				#if _DETAIL_R
					ContributeDetailA(o, _AlbedoMapR, coords, polar, max_height, noise, d.blackboard.detailMask.r * _BakedDetailScaleR_Ext_1 * fade);
				#endif
				#if _DETAIL_G
					ContributeDetailA(o, _AlbedoMapG, coords, polar, max_height, noise, d.blackboard.detailMask.g * _BakedDetailScaleG_Ext_1 * fade);
				#endif
				#if _DETAIL_B
					ContributeDetailA(o, _AlbedoMapB, coords, polar, max_height, noise, d.blackboard.detailMask.b * _BakedDetailScaleB_Ext_1 * fade);
				#endif
				#if _DETAIL_A
					ContributeDetailA(o, _AlbedoMapA, coords, polar, max_height, noise, d.blackboard.detailMask.a * _BakedDetailScaleA_Ext_1 * fade);
				#endif
			#endif

			#if _DETAIL_NORMAL
				#if _DETAIL_R
					ContributeDetailN(o, _NormalMapR, coords, polar, max_height, noise, d.blackboard.detailMask.r * _BakedDetailScaleR_Ext_1 * fade);
				#endif
				#if _DETAIL_G
					ContributeDetailN(o, _NormalMapG, coords, polar, max_height, noise, d.blackboard.detailMask.g * _BakedDetailScaleG_Ext_1 * fade);
				#endif
				#if _DETAIL_B
					ContributeDetailN(o, _NormalMapB, coords, polar, max_height, noise, d.blackboard.detailMask.b * _BakedDetailScaleB_Ext_1 * fade);
				#endif
				#if _DETAIL_A
					ContributeDetailN(o, _NormalMapA, coords, polar, max_height, noise, d.blackboard.detailMask.a * _BakedDetailScaleA_Ext_1 * fade);
				#endif
			#endif
		#endif
	}
	...
	void Ext_SurfaceFunction7 (inout Surface o, inout ShaderData d)
	{
		#if _BAKEDDETAIL_ON_DEF_2
			#if 02 == 0
				float4 coords     = d.texcoord0 * _BakedDetailTilingAMul;
				float  max_height = _BakedDetailTilingA;
			#elif 02 == 1
			...
			float polar = d.extraV2F0.x;
			float noise = (sample_noise(coords, polar) - 0.5f) * 5.0f;
			float fade  = saturate(d.blackboard.worldDistance / _BakedDetailFadeRange_Ext_2);
			...
			#if _DETAIL_ALBEDO
				#if _DETAIL_R
					ContributeDetailA(o, _AlbedoMapR, coords, polar, max_height, noise, d.blackboard.detailMask.r * _BakedDetailScaleR_Ext_2 * fade);
				#endif
				#if _DETAIL_G
					ContributeDetailA(o, _AlbedoMapG, coords, polar, max_height, noise, d.blackboard.detailMask.g * _BakedDetailScaleG_Ext_2 * fade);
				#endif
				#if _DETAIL_B
					ContributeDetailA(o, _AlbedoMapB, coords, polar, max_height, noise, d.blackboard.detailMask.b * _BakedDetailScaleB_Ext_2 * fade);
				#endif
				#if _DETAIL_A
					ContributeDetailA(o, _AlbedoMapA, coords, polar, max_height, noise, d.blackboard.detailMask.a * _BakedDetailScaleA_Ext_2 * fade);
				#endif
			#endif

			#if _DETAIL_NORMAL
				#if _DETAIL_R
					ContributeDetailN(o, _NormalMapR, coords, polar, max_height, noise, d.blackboard.detailMask.r * _BakedDetailScaleR_Ext_2 * fade);
				#endif
				#if _DETAIL_G
					ContributeDetailN(o, _NormalMapG, coords, polar, max_height, noise, d.blackboard.detailMask.g * _BakedDetailScaleG_Ext_2 * fade);
				#endif
				#if _DETAIL_B
					ContributeDetailN(o, _NormalMapB, coords, polar, max_height, noise, d.blackboard.detailMask.b * _BakedDetailScaleB_Ext_2 * fade);
				#endif
				#if _DETAIL_A
					ContributeDetailN(o, _NormalMapA, coords, polar, max_height, noise, d.blackboard.detailMask.a * _BakedDetailScaleA_Ext_2 * fade);
				#endif
			#endif
		#endif
	}
	...
	void Ext_SurfaceFunction8 (inout Surface o, inout ShaderData d)
	{
		#if _SHORE_ON
	...
	void Ext_SurfaceFunction9 (inout Surface o, inout ShaderData d)
	{
		#if _NIGHT
