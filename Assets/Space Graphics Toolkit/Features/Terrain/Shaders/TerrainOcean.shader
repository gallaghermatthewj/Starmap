...
Shader "Space Graphics Toolkit/Terrain Ocean"
{
   Properties
   {
	...
	_BakedDetailScale_Ext_1("	Strength", Range(0,5)) = 1
	[NoScaleOffset][Normal]_BakedDetailMap_Ext_1("	Normal", 2D) = "bump" {}


	[Header(BAKED DETAIL)]
	[Toggle(_BAKEDDETAIL_ON_DEF_2)] _HasBakedDetail_Ext_2("	Enabled", Float) = 0
	_BakedDetailFadeRange_Ext_2("	Fade Range", Float) = 1000.0
	_BakedDetailScale_Ext_2("	Strength", Range(0,5)) = 1
	[NoScaleOffset][Normal]_BakedDetailMap_Ext_2("	Normal", 2D) = "bump" {}
   ...
   SubShader
   {
      Tags { "RenderPipeline" = "HDRenderPipeline" "Queue" = "Transparent-1" }
...
// HDRP Adapter stuff
	...
	float _BakedDetailScale_Ext_1;


	float _BakedDetailFadeRange_Ext_2;
	float _BakedDetailScale_Ext_2;
...
#define unity_WorldToObject GetWorldToObjectMatrix()
	...
	void Ext_SurfaceFunction8 (inout Surface o, inout ShaderData d)
	{
			...
			ContributeDetail(o, _BakedDetailMap, coords, polar, max_height, noise, _BakedDetailScale * fade);
		#endif
	}


	sampler2D _BakedDetailMap_Ext_1;
	...
	void Ext_SurfaceFunction9 (inout Surface o, inout ShaderData d)
	{
			...
			ContributeDetail(o, _BakedDetailMap_Ext_1, coords, polar, max_height, noise, _BakedDetailScale_Ext_1 * fade);
		#endif
	}


	sampler2D _BakedDetailMap_Ext_2;

	void Ext_SurfaceFunction10 (inout Surface o, inout ShaderData d)
	{
			...
			ContributeDetail(o, _BakedDetailMap_Ext_2, coords, polar, max_height, noise, _BakedDetailScale_Ext_2 * fade);
		#endif
	}
	...
	void Ext_SurfaceFunction11 (inout Surface o, inout ShaderData d)
	{
		o.Albedo = TintDepth(o.Albedo, d);
	}


	void Ext_SurfaceFunction12 (inout Surface o, inout ShaderData d)
	{
		#if _ALPHA_OFF
			o.Alpha = 1.0f;
		#else
	...
	void Ext_SurfaceFunction13 (inout Surface o, inout ShaderData d)
	{
		#if _REFRACTION_ON
			float3 depthPos = GetWorldPositionFromDepthBuffer(d.screenUV, d.worldSpaceViewDir);
			float  depthDist = distance(depthPos, _WorldSpaceCameraPos);
	...
	void Ext_SurfaceFunction14 (inout Surface o, inout ShaderData d)
	{
