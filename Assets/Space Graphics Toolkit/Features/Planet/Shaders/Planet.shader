...
Shader "Space Graphics Toolkit/Planet"
{
   Properties
   {
	...
	[Header(DETAIL)]
	[Toggle(_DETAIL_ON_DEF_1)] _HasDetail_Ext_1 ("	Enabled", Float) = 0
	_DetailTiling_Ext_1("	Tiling", Float) = 10
	_DetailFadeRange_Ext_1("	Fade Range", Float) = 1000.0
	_DetailScaleR_Ext_1("	Strength R", Range(0,5)) = 1
	_DetailScaleG_Ext_1("	Strength G", Range(0,5)) = 1
	_DetailScaleB_Ext_1("	Strength B", Range(0,5)) = 1
	_DetailScaleA_Ext_1("	Strength A", Range(0,5)) = 1
   ...
   SubShader
   {
	...
	#pragma shader_feature_local _ _DETAIL_ON_DEF_1
...
// HDRP Adapter stuff
	...
	float _DetailTiling_Ext_1;
	float _DetailFadeRange_Ext_1;
	float _DetailScaleR_Ext_1;
	float _DetailScaleG_Ext_1;
	float _DetailScaleB_Ext_1;
	float _DetailScaleA_Ext_1;
...
#define unity_WorldToObject GetWorldToObjectMatrix()
	...
	void Ext_SurfaceFunction5 (inout Surface o, inout ShaderData d)
	{
		#if _DETAIL_ON_DEF_1
			float4 coords     = d.texcoord0;
			float  max_height = _DetailTiling_Ext_1;

			coords.x *= 2.0f;
			coords *= _DetailTiling_Ext_1;

			float polar = d.extraV2F0.x;
			float noise = sample_noise(coords / 64.0f, polar) - 0.5f;
			float fade  = saturate(d.blackboard.worldDistance / _DetailFadeRange_Ext_1);

			#if _DETAIL_ALBEDO
				#if _DETAIL_R
					ContributeDetailA(o, _AlbedoMapR, coords, polar, max_height, noise, d.blackboard.detailMask.r * _DetailScaleR_Ext_1 * fade);
				#endif
				#if _DETAIL_G
					ContributeDetailA(o, _AlbedoMapG, coords, polar, max_height, noise, d.blackboard.detailMask.g * _DetailScaleG_Ext_1 * fade);
				#endif
				#if _DETAIL_B
					ContributeDetailA(o, _AlbedoMapB, coords, polar, max_height, noise, d.blackboard.detailMask.b * _DetailScaleB_Ext_1 * fade);
				#endif
				#if _DETAIL_A
					ContributeDetailA(o, _AlbedoMapA, coords, polar, max_height, noise, d.blackboard.detailMask.a * _DetailScaleA_Ext_1 * fade);
				#endif
			#endif

			#if _DETAIL_NORMAL
				#if _DETAIL_R
					ContributeDetailN(o, _NormalMapR, coords, polar, max_height, noise, d.blackboard.detailMask.r * _DetailScaleR_Ext_1 * fade);
				#endif
				#if _DETAIL_G
					ContributeDetailN(o, _NormalMapG, coords, polar, max_height, noise, d.blackboard.detailMask.g * _DetailScaleG_Ext_1 * fade);
				#endif
				#if _DETAIL_B
					ContributeDetailN(o, _NormalMapB, coords, polar, max_height, noise, d.blackboard.detailMask.b * _DetailScaleB_Ext_1 * fade);
				#endif
				#if _DETAIL_A
					ContributeDetailN(o, _NormalMapA, coords, polar, max_height, noise, d.blackboard.detailMask.a * _DetailScaleA_Ext_1 * fade);
				#endif
			#endif
		#endif
	}
	...
	void Ext_SurfaceFunction7 (inout Surface o, inout ShaderData d)
	{
			...
			float4 waterPix    = sample_spherical(_WaterTexture, coords, polar + noise, _WaterTiling);
