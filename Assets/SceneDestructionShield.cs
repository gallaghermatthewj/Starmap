...
/// </summary>
public class SceneDestructionShield : MonoBehaviour
{
    ...
    void CheckForDuplicateInstances()
    {
        ...
        SceneDestructionShield[] collection = FindObjectsOfType<SceneDestructionShield>();

        // iterate through the objects with this component, deleting those with matching identifiers
        foreach (SceneDestructionShield obj in collection)
        {
